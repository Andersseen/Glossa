...
export class UiTooltip {
  readonly uiTooltip = input<NgpOverlayContent<unknown> | string | null>(null);
  ...
  readonly showOnOverflow = input<boolean, unknown>(false, {
  ...
  readonly useTextContent = input<boolean, unknown>(false, {
    transform: booleanAttribute,
  });
  readonly trackPosition = input<boolean, unknown>(false, {
    transform: booleanAttribute,
  });
